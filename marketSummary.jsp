<%@ page import="java.util.Collection, java.util.Iterator, java.math.BigDecimal,com.ibm.icap.tradelite.*,com.ibm.icap.tradelite.util.*,com.ibm.icap.tradelite.direct.*" session="true" isThreadSafe="true" isErrorPage="false"%>
...
%>
            <TABLE border="1" bgcolor="#ffffff" width="100%" style="font-size: smaller" align="center">
                <TBODY>
                    <TR>
                    ...
                    <TR>
                        ...
                        <TD bgcolor="#ffffff">
                        <TABLE width="100%" border="1" height="100%" style="font-size: smaller" align="center">
                            <TBODY>
                                <TR align="center">
