...
<BODY bgcolor="#ffffff" link="#000099" background="images/background2.jpg">
<%@ page session="false" %>
...
<TABLE width="616" align="center">
  <TBODY>
    ...
    <TR>
      <TD align="right">
            <FORM action="app" method="POST"><INPUT size="10" type="text" name="uid" value="uid:0"> &nbsp; &nbsp; &nbsp; &nbsp; <INPUT size="10" type="password" name="passwd" value="xxx"> &nbsp; <INPUT name=login type="submit" value="Log in"><INPUT type="hidden" name="action" value="login"></FORM>
            </TD>
    </TR>
    </TBODY>
</TABLE>
