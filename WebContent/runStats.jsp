...
<%@ page import="com.ibm.icap.tradelite.*" session="false" isThreadSafe="true" isErrorPage="false" %>

<jsp:useBean class="com.ibm.icap.tradelite.RunStatsDataBean" id="runStatsData" scope="request" />
<% 
...
<TABLE style="font-size: smaller" align="center">
  <TBODY>
    <TR>
...
<TABLE width="639" height="30" align="center">
  <TBODY>
        <TR>
            ...
            <TABLE width="100%" align="center">
                <TBODY>
                    <TR align="center">
                        <TD colspan="6">
                        <CENTER></CENTER>
                        <TABLE border="1" style="font-size: smaller" cellpadding="2" cellspacing="0" align="center">
